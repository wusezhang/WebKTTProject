$(document).ready(function(){
	...
	function  chinaNewsDownEvent(){
		currentCount = 0 ;
    	if((Number($('#chinaNewsCount').val())+10)>Number($('#chinaNewsTotalCount').val())){
    		currentCount = Number($('#chinaNewsCount').val());
    	}else{
    		currentCount = Number($('#chinaNewsCount').val())+10;
    	}
	...
	function  chinaNewsUpEvent(){
		currentData = 0;
    	if((Number($('#chinaNewsCount').val())-10)>0){
    		currentData = Number($('#chinaNewsCount').val())-10;
    	}
